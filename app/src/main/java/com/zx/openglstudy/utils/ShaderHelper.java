...
public class ShaderHelper {
    ...
    private static int compileShader(int type, String shaderCode) {
        ...
        if (shaderObjectId == 0) {
            LogUtils.w("Could not create new shader.");
        ...
        LogUtils.v("Results of compiling source:" + "\n" + shaderCode + "\n:"
        ...
        if (compileStatus[0] == 0) {
            ...
            LogUtils.w("Compilation of shader failed.");
    ...
    public static int linkProgram(int vertexShaderId, int fragmentShaderId) {
        ...
        if (programObjectId == 0) {
            LogUtils.w("Could not create new program");
        ...
        if (linkStatus[0] == 0) {
            ...
            LogUtils.w("Linking of program failed.");
            return 0;
        }
    ...
    public static boolean validateProgram(int programObjectId) {
        ...
        LogUtils.v("Results of validating program: " + validateStatus[0]
